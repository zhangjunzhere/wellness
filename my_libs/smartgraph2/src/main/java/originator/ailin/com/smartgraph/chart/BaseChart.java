...
import originator.ailin.com.smartgraph.Utils.Constant;
import originator.ailin.com.smartgraph.axis.AxisAbs;
import originator.ailin.com.smartgraph.grid.GridAbs;
import originator.ailin.com.smartgraph.icon.IconAbs;
...
public abstract class BaseChart extends SurfaceView implements SurfaceHolder.Callback{
     ...
     * @param paint
     */
    protected void showIcon(Resources resources, Canvas canvas, Paint paint) {
        icon.drawIcon(resources, canvas, paint);
    }
    ...
    public void setIcon(IconAbs icon) {
        this.icon = icon;
    }
     ...
     */
    private void init() {
        Constant.putColorValues(getResources());
        paint = new Paint();
