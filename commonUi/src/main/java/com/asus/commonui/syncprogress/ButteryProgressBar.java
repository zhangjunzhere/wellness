...
public class ButteryProgressBar extends View {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        if (mSyncProgressTracker != null) {
            mSyncProgressTracker.relayoutHintText();
            mSyncProgressTracker.computeDistanceToTriggerSync();
        }
    ...
    protected void setTracker(SyncProgressTracker tracker) {
        mSyncProgressTracker = tracker;
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        stop();
        mSyncProgressTracker.detachedHintText();
