...
import com.asus.commonui.drawerlayout.DrawerLayout.LayoutParams;
...
public class ViewDragHelper {
    ...
    public boolean continueSettling(boolean deferCallbacks) {
        if (mDragState == STATE_SETTLING && mCapturedView != null) {
    ...
    private void ensureMotionHistorySizeForId(int pointerId) {
        if (mInitialMotionX == null || mInitialMotionX.length <= pointerId) {
            ...
            if (mInitialMotionX != null) {
                System.arraycopy((Object) mInitialMotionX, 0, (Object) imx, 0, mInitialMotionX.length);
                System.arraycopy((Object) mInitialMotionY, 0, (Object) imy, 0, mInitialMotionY.length);
                System.arraycopy((Object) mLastMotionX, 0, (Object) lmx, 0, mLastMotionX.length);
                System.arraycopy((Object) mLastMotionY, 0, (Object) lmy, 0, mLastMotionY.length);
                System.arraycopy((Object) mInitialEdgesTouched, 0, (Object) iit, 0, mInitialEdgesTouched.length);
                System.arraycopy((Object) mEdgeDragsInProgress, 0, (Object) edip, 0, mEdgeDragsInProgress.length);
                System.arraycopy((Object) mEdgeDragsLocked, 0, (Object) edl, 0, mEdgeDragsLocked.length);
            }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    final View tmpToCapture = findTopChildUnder((int) x, (int) y);
                    final View toCapture = isDrawerView(tmpToCapture) ? findContentView() : tmpToCapture;
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                tryCaptureViewForDrag(toCapture, pointerId);
                    ...
                    tryCaptureViewForDrag(findContentView(), pointerId);
    ...
    private void dragTo(int left, int top, int dx, int dy) {
        if (mCapturedView != null) {
            ...
            if (dy != 0) {
                clampedY = mCallback.clampViewPositionVertical(mCapturedView,
                        top, dy);
            ...
            if (dx != 0 || dy != 0) {
                ...
                mCallback.onViewPositionChanged(mCapturedView, clampedX,
