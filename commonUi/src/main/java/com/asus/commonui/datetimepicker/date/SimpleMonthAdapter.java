...
import com.asus.commonui.datetimepicker.date.SimpleMonthView.OnDayClickListener;
...
public class SimpleMonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (display.getDisplayId() != Display.DEFAULT_DISPLAY) {
            ...
            drawingParams.put(SimpleMonthView.VIEW_PARAMS_HEIGHT, (((int) (size.y * Utils.SCALE_FOR_DUALAPPS)
                    - SimpleMonthView.MONTH_HEADER_SIZE) / SimpleMonthView.MAX_NUM_ROWS));
        }
