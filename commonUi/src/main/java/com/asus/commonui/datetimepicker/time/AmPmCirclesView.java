...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        mUnselectedColor = res.getColor(R.color.asus_commonui_white);
        mSelectedColor = res.getColor(R.color.asus_commonui_blue);
        mAmPmTextColor = res.getColor(R.color.asus_commonui_ampm_text_color);
        mSelectedAlpha = SELECTED_ALPHA;
        String typefaceFamily = res.getString(R.string.asus_commonui_sans_serif);
        ...
        mCircleRadiusMultiplier =
                Float.parseFloat(res.getString(R.string.asus_commonui_circle_radius_multiplier));
        mAmPmCircleRadiusMultiplier =
                Float.parseFloat(res.getString(R.string.asus_commonui_ampm_circle_radius_multiplier));
        String[] amPmTexts = TimePickerDialog.getShortAmPmStrings();
        mAmText = amPmTexts[0];
        mPmText = amPmTexts[1];
    ...
    /* package */ void setTheme(Context context, boolean themeDark) {
        Resources res = context.getResources();
        if (themeDark) {
            mUnselectedColor = res.getColor(R.color.asus_commonui_dark_gray);
            mSelectedColor = res.getColor(R.color.asus_commonui_red);
            mAmPmTextColor = res.getColor(R.color.asus_commonui_white);
