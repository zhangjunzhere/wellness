...
public class SimpleMonthView extends View {
    ...
    // BEGIN ChengHua_Chien@asus.com remove support lib "android.support.v4"
    //private final MonthViewTouchHelper mTouchHelper;
    // END ChengHua_Chien@asus.com
    ...
    public SimpleMonthView(Context context) {
        ...
        mDayOfWeekTypeface = res.getString(R.string.asus_commonui_day_of_week_label_typeface);
        mMonthTitleTypeface = res.getString(R.string.asus_commonui_sans_serif);

        mDayTextColor = res.getColor(R.color.asus_commonui_date_picker_text_normal);
        mTodayNumberColor = res.getColor(R.color.asus_commonui_blue);
        mMonthTitleColor = res.getColor(R.color.asus_commonui_white);
        mMonthTitleBGColor = res.getColor(R.color.asus_commonui_circle_background);

        mStringBuilder = new StringBuilder(50);
        mFormatter = new Formatter(mStringBuilder, Locale.getDefault());

        MINI_DAY_NUMBER_TEXT_SIZE = res.getDimensionPixelSize(R.dimen.asus_commonui_day_number_size);
        MONTH_LABEL_TEXT_SIZE = res.getDimensionPixelSize(R.dimen.asus_commonui_month_label_size);
        MONTH_DAY_LABEL_TEXT_SIZE = res.getDimensionPixelSize(R.dimen.asus_commonui_month_day_label_text_size);
        MONTH_HEADER_SIZE = res.getDimensionPixelOffset(R.dimen.asus_commonui_month_list_item_header_height);
        DAY_SELECTED_CIRCLE_SIZE = res
                .getDimensionPixelSize(R.dimen.asus_commonui_day_number_select_circle_radius);

        mRowHeight = (res.getDimensionPixelOffset(R.dimen.asus_commonui_date_picker_view_animator_height)
