...
public class ForumActivity extends BaseListActivity implements SearchActivity {
    ...
    private static final int POSTID_INTENT = 0x5566;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else mAppTitle = Session.getInstance().getConfig().getAPPTitle();
        if(mAppTitle == null)setTitle(R.string.uf_sdk_user_forum);
        else setTitle(mAppTitle);
        ...
        setListAdapter(new PaginatedAdapter<Suggestion>(this, R.layout.uv_suggestion_item, suggestions) {
            ...
            protected void customizeLayout(View view, Suggestion model) {
                ...
                if (model.getStatus() == null) {
                    ...
                    textView.setText((Suggestion.getTranslationStatus(context, model.getStatus())).toUpperCase(Locale.getDefault()));
        ...
        getListView().setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    startActivityForResult(new Intent(ForumActivity.this, PostIdeaActivity.class), POSTID_INTENT);
                } else if (position != 1) {
                    Suggestion suggestion = (Suggestion) getModelAdapter().getItem(position);
                    if(suggestion != null){
                        SuggestionDialogFragment dialog = new SuggestionDialogFragment();
                        Bundle args = new Bundle(2);
                        args.putParcelable(SuggestionDialogFragment.ARG_SUGGESTION, suggestion);
    ...
    protected void onResume() {
        ...
        super.onResume();
        if(forum != null) GAManager.FORUM.view(this, forum.getId());
    }
    @Override
    ...
    private void loadForum() {
        ...
        if (Session.getInstance().getForum() != null) {
            ...
            if(mAppTitle == null) setTitle(forum.getName());
        ...
        Forum.loadForum(Session.getInstance().getConfig().getForumId(), new DefaultCallback<Forum>(this) {
            ...
            public void onModel(Forum model) {
                ...
                if(mAppTitle == null) setTitle(forum.getName());
                getModelAdapter().loadMore();
                if(forum != null) GAManager.FORUM.view(ForumActivity.this, forum.getId());
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == POSTID_INTENT && resultCode == RESULT_OK) {
            getModelAdapter().reload();
        }
