...
public class SigninManager {
    ...
    private void signIn() {
        if ((email != null && email.equals(Session.getInstance().getEmail()) && name !=null && name.equals(Session.getInstance().getName()))&&(Session.getInstance().getAccessToken() != null)) {
    ...
    public static void signinForSubscribe(FragmentActivity activity, String email, String name, SigninCallback callback) {
        SigninManager manager = new SigninManager(activity, email, name, callback);
