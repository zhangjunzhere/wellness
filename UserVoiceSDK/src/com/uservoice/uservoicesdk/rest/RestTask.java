...
public class RestTask extends AsyncTask<String, String, RestResult> {
    ...
    protected RestResult doInBackground(String... args) {
        ...
        try {
            ...
            String acceptLanguageValue = Locale.getDefault().getLanguage();
            String country = Locale.getDefault().getCountry();

            if (country.equals("CN")) {
                acceptLanguageValue = "cn";
            }

            //request.setHeader("Accept-Language", acceptLanguageValue.equals("zh") ? "zh-TW" : acceptLanguageValue);
