...
public class Ticket extends BaseModel {
    ...
    public static void createTicket(String message, String email, String name, Map<String, String> customFields, final Callback<Ticket> callback) {
        createTicket(message, email, name, customFields, getSession().getConfig().getAttachmentList(), callback);
    }

    public static void createTicket(String message, String email, String name, Map<String, String> customFields, List<Attachment> attachmentList, final Callback<Ticket> callback) {
