...
public class Comment extends BaseModel {
    ...
    public static void loadComments(Suggestion suggestion, int page, final Callback<List<Comment>> callback, final CountCallback countCallback) {
        ...
        doGet(apiPath("/forums/%d/suggestions/%d/comments.json", suggestion.getForumId(), suggestion.getId()), params, new RestTaskCallback(callback) {
            ...
            public void onComplete(JSONObject object) throws JSONException {
                JSONObject response = object.getJSONObject("response_data");
                countCallback.updateCount(response.getInt("total_records"));
